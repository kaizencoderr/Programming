from operator import add, index, mul, sub
...
def make_repeater(func, n):
    ...
    def helper(x):
        ...
        i=1
        while i<=n:
            #apply func to x, keep track of that with variable tracker
...
def count_coins(change):
    ...
    #def count_helper(change, smallest_coin):
            ...
            #return 0
        #else:
            #return count_helper(change, get_next_coin(smallest_coin)) + count_helper(change-smallest_coin, smallest_coin)
