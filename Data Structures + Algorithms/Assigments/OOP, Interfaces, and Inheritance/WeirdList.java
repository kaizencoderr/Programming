...
public class WeirdList {
    ...
    /** A class created to help complete WeirdList empty method*/
    private static class weird_empty extends WeirdList {
        public weird_empty(int head, WeirdList tail) { super(head, tail); }
        @Override
    ...
    public WeirdList map(IntUnaryFunction func) {
        WeirdList mapper = new WeirdList(func.apply(_head), _tail.map(func));
        return mapper;
    }
